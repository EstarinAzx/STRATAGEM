...
> **Last updated**: 2026-05-08 — v0.3.65
...
├── src/                    # All source code
├── package.json            # v0.3.65, name: stratagem-x7
...
## 6. Recent Commit History (v0.3.27 → v0.3.65)

Per-version notes for v0.3.46 onward live in [`changelog/`](changelog/README.md).

| Version | Commit | Change |
|---|---|---|
| **0.3.65** | _pending_ | fix: openclaude path test sweep + isManagedLocalInstallationPath Windows path normalization |
