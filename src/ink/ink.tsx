...
import { dispatchClick, dispatchHover, dispatchPress } from './hit-test.js';
...
export default class Ink {
  ...
  /**
   * Hit-test the rendered DOM tree at (col, row) and bubble a PressEvent
   * up through ancestors with onPress handlers. Returns the DragHandler
   * installed via event.beginDrag() — non-null means App should suppress
   * text-selection start and route subsequent move/release to it.
   */
  dispatchPress(col: number, row: number): DragHandler | null {
  ...
  render(node: ReactNode): void {
    ...
    const tree = <App stdin={this.options.stdin} stdout={this.options.stdout} stderr={this.options.stderr} exitOnCtrlC={this.options.exitOnCtrlC} onExit={this.unmount} terminalColumns={this.terminalColumns} terminalRows={this.terminalRows} selection={this.selection} onSelectionChange={this.notifySelectionChange} onClickAt={this.dispatchClick} onPressAt={this.dispatchPress} onHoverAt={this.dispatchHover} getHyperlinkAt={this.getHyperlinkAt} onOpenHyperlink={this.openHyperlink} onMultiClick={this.handleMultiClick} onSelectionDrag={this.handleSelectionDrag} onStdinResume={this.reassertTerminalModes} onCursorDeclaration={this.setCursorDeclaration} dispatchKeyboardEvent={this.dispatchKeyboardEvent}>
