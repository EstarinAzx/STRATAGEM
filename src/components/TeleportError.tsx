    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text color="gray">Teleport requires a Claude.ai account.</Text><Text color="gray">Your Claude Pro/Max subscription will be used by Stratagem.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
