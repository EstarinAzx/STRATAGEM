...
export function UserPromptMessage({
  ...
  // Channel-direction framing: ▲ marks uplink (operator → agent); the
  // matching ▼ on the assistant border below reads as a back-and-forth
  // across one channel. Kept short so it fits inside the auto-shrunk
  // bordered Box even for very short prompts ("hi") — the longer
  // "UPLINK :: USER" form truncated to "UPLINK :: U" on narrow boxes.
