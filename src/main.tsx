...
import { CURRENT_MIGRATION_VERSION, eagerLoadSettings, initializeEntrypoint, isBeingDebugged, logManagedSettings, logSessionTelemetry, logStartupTelemetry, runMigrations } from './bootstrap/startup.js';
