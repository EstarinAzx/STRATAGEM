...
function SessionInfo(t0) {
  ...
  if (!remoteSessionUrl) {
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
      t4 = <Pane title="SESSION"><Text color="warning">Not in remote mode. Start with `stx7 --remote` to use this command.</Text><Text dimColor={true}>(press esc to close)</Text></Pane>;
      $[4] = t4;
    } else {
      t4 = $[4];
    }
